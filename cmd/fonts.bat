...
%ADB_DIR%\adb push ..\add\fonts\DroidSansFallbackFull.ttf /system/fonts 
%ADB_DIR%\adb shell chmod 644 /system/fonts/DroidSansFallbackFull.ttf
%ADB_DIR%\adb push ..\add\fonts\DroidSansFallback.ttf /system/fonts 
%ADB_DIR%\adb shell chmod 644 /system/fonts/DroidSansFallback.ttf
cmd
