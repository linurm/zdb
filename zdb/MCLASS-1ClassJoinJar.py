...
if __name__=='__main__':
    ...
    cmd = '{}\\d2j-class-join-jar.bat {}\\classjoin\\Utils.class -i {}\\{}.jar -f -d -p com.googlecode.dex2jar.tools.ZjUtils -o {}\\{}-addclass.jar'.format(dex2jar_dir, pkg_path, pkg_path, apk_name, pkg_path, apk_name)
    print '#######',cmd
    os.system("{}".format(cmd))
    raw_input('Pause')
'''
